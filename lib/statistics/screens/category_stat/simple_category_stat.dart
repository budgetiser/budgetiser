...
class SimpleCategoryStatTables extends StatelessWidget {
  const SimpleCategoryStatTables({
    super.key,
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: TransactionModel().getCategoryStats(
        categories,
        DateTimeRange(
          start: startDate,
          end: DateTime.now(),
