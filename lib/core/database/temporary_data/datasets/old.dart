...
class OldDataset extends DemoDataset {
  static final OldDataset _instance = OldDataset._internal();

  /// Dataset uses singleton
  factory OldDataset() {
    return _instance;
  }
  OldDataset._internal() {
    ...
    void addCategory(String name, IconData icon) {
      list.add(
        TransactionCategory(
          ...
          name: name,
          icon: icon,
          color: _availableColors[id % _availableColors.length],
          description: '',
          archived: false,
        ),
      );
